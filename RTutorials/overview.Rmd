...
| -------------- | --------- | -------------------------------------------------- |
RStudio Desktop | pros | You install your own (free) copy on your personal computer that is yours to use for future data-analysis projects. Has well-developed tools for authoring documents such as homework assignments and written reports. Supported by an extensive online community of users. Used in all class demos. The Stats grads/undergrads who staff the Workshop install it on their own computers for their own research and assignments and so someone in the Workshop can help you with installation if you bring in your computer. 
|   | cons  | Macs with non-standard characters (e.g. Chinese) can be trickier to install on but troubleshooting instructions can be found [here] (https://github.com/SFUStatgen/RforStat2/blob/master/RTutorials/GettingStarted/startR-RStudio.Rmd) or through the Workshop Canvas site. |
