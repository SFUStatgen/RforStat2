...
big bucks), but I will always 
give you templates to work from.
...
$t$, from sample means and SDs and needed to find
the corresponding $p$-value, $2 P( T\geq |t|)$, for a 2-sided
alternative hypothesis.
    + Here $T$ is a random variable having
    a t distribution on $\nu=31.465$ degrees of freedom.
* In the "old" days we looked up p-values in 
