...
subtitle: 'Chapter 15, part 3: McNemar''s Test (take 2)'
author: "Jinko Graham"
date: '2018-10-24'
output: 
  beamer_presentation:
...
* Application to autoimmune or type 1 diabetes (T1D):
    ...
    near the insulin gene genetically linked 
    to a
...
* Is the "1" variant of the DNA marker associated with being
transmitted?
...
* Use McNemar's test (see R Demo) to assess whether the 
proportion of "1" variants in the population of transmitted 
variants is the same as the proportion of "1" variants in the 
population of untransmitted variants: 
...
* Strong evidence that the "1" variant is
preferentially transmitted over the "X" variant 
to the affected child.   
 $\rightarrow$ The DNA marker 5'FP is
    linked to T1D.
