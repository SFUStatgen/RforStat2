...
* This plot can show evidence of
    1. departures from the assumption of a linear relationship:
...
## Departures from linearity: EG.1
...
## Departures from linearity: EG.2
...
as $\hat{y}$ increases so does the spread of the residuals;
    + Suggests that, as population mean response increases, so does the response sd.
