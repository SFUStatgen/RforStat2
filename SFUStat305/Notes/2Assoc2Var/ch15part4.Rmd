...
* Smoking is associated with a 9.1-fold increase in the odds of lung cancer.
* Or, if lung cancer is **rare**, we can interpret the OR as an RR and say:
    + smoking is associated with a 9.1-fold increase in the ***risk*** of lung cancer. 

## Interpretation of Interval Estimates of OR

* "With 95% confidence, we estimate that
smoking is associated with a 4.1 to 20-fold
...
* Famously, the iconic geneticist and statistician RA Fisher was violently opposed to it. 
<!--
