...
* This gives an estimate of the conditional distributions of cancer stage in each gender.
...
* This gives an estimate of the conditional distributions of gender in each cancer stage.
...
the overall distribution of the row variable.
    + E.G., if the conditional gender distribution is 
    25% female and 75% male in each cancer stage, we will
    have 25% females and 75% males overall too.
* When this happens we say that the column and row variables are
