...
uploading a question to Crowdmark (typically, a separate PDF is to be uploaded for each question). Please be aware that the Crowdmark server can crash if everyone tries to upload their assignment at the last minute. The Workshop is not responsible for late assignments owing to server crashes. To ensure that your assignment is counted, please leave plenty of lead time to submit it before the deadline.
