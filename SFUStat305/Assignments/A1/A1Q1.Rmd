...
# there to help you with working things out and getting comfortable 
# with R; please make use of this excellent resource. Go early to 
# avoid the last-minute rush and crashing the servers. Watch out 
# especially for crashing Crowdmark if you are trying to upload 
# your assignment at the last minute. The Workshop is not 
# responsible for late assignments due to Crowdmark crashing.  
```
