...
1. Choose all that apply: 
    a. We use statistics such as the sample mean to assess the evidence in a sample for statistical hypotheses.
    b. Statistical hypotheses ask questions about sample quantities known as statistics.
    c. Statistical hypotheses ask questions about population quantities known as parameters.
